...
// Used in KNX RF packet validation.

static const uint16_t KNX_CRC_TABLE[256] = {
  ...
  0xED4E,0xFD6F,0xCD0C,0xDD2D,0xADCA,0xBDEB,0x8D88,0x9DA9,
  0x7E77,0x6E56,0x5E35,0x4E14,0x3EF3,0x2ED2,0x1EB1,0x0E90,
  0xFF7F,0xEF5E,0xDF3D,0xCF1C,0xBFFB,0xAFDA,0x9FB9,0x8F98,
...
static inline uint16_t knx_crc16(const uint8_t *data, uint8_t length) {
  ...
  for (uint8_t i = 0; i < length; i++) {
    crc = (crc << 8) ^ KNX_CRC_TABLE[((crc >> 8) ^ data[i]) & 0xFF];
  }
  return crc;
}
